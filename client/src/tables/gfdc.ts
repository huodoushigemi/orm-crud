...
export const gfdc_auth_role: TableOpt = {
  ...
  fields: [
    ...
    { label: '系统ID', prop: "SYSTEM", relation: { table: 'gfdc_auth_system_info', rel: 'n-1' }, inverseSide: { label: '角色', prop: 'ROLE' } },
    { label: '创建人工号', prop: "CREATOR_NO" },
    { label: '创建人', prop: "CREATOR" },
    { label: '创建时间', prop: "CREATE_TIME" },
    { label: '修改人工号', prop: "MODIFIER_NO" },
...
export const gfdc_guide_config: TableOpt = {
  ...
  fields: [
    { label: 'ID', prop: 'ID' },
    { label: '系统编码', prop: 'SYSTEM_CODE' },
    { label: '生效范围', prop: 'EFFECTIVE_SCOPE', options: [{ label: '产品指南', value: 'SystemGuide' }, { label: '操作指南', value: 'BiGuide' }, { label: '常见问题', value: 'QuestionNormally' }] },
    { label: '标题', prop: 'TITLE', filter: 'contains' },
    { label: '图标', prop: 'ICON' },
    { label: '内容', prop: 'CONTENT', editor: { type: 'textarea', autosize: { minRows: 4 } }, render: { is: 'my-html' } },
    { label: '有效', prop: 'IF_VALID', options: [{ label: '失效', value: 0 }, { label: '有效', value: 1 }] },
    { label: '排序', prop: 'SORT' },
    { label: '创建人工号', prop: 'CREATOR_NO' },
    { label: '创建人', prop: 'CREATOR' },
    { label: '创建时间', prop: 'CREATE_TIME' },
...
export const gfdc_message_object: TableOpt = {
  ...
  fields: [
    { label: 'ID', prop: 'ID' },
    { label: '消息名称', prop: 'MESSAGE_NAME', filter: 'contains' },
    { label: '消息编码', prop: 'MESSAGE_CODE', filter: 'contains' },
    { label: '类型', prop: 'TYPE' },
    { label: '标题', prop: 'TITLE' },
...
export const gfdc_message_task: TableOpt = {
  ...
  fields: [
    { label: 'ID', prop: 'ID' },
    { label: '任务名', prop: 'JOB_NAME' }, // TODO 关联 MESSAGE_CODE
    { label: '描述', prop: 'DESCRIPTION' },
    { label: 'cron表达式', prop: 'CRON_EXPRESSION' },
    { label: '类名', prop: 'BEAN_CLASS' },
    { label: '方法名', prop: 'METHOD_NAME' },
    { label: '启用', prop: 'JOB_STATUS', options: [{ label: '禁用', value: 0 }, { label: '启用', value: 1 }] },
    { prop: 'PARAMS' },
    { label: '创建人工号', prop: 'CREATOR_NO' },
    { label: '创建人', prop: 'CREATOR' },
    { label: '创建时间', prop: 'CREATE_TIME' },
...
export const gfdc_sjkd_data_model: TableOpt = {
  ...
  fields: [
    { label: '主键', prop: 'ID' },
    { label: '模型编码', prop: 'MODEL_CODE' },
    { label: '模型名称', prop: 'MODEL_NAME', filter: 'contains' },
    { label: '数据表单json', prop: 'DATA_FORM_JSON' },
    { label: '创建人工号', prop: 'CREATOR_NO' },
    { label: '创建人', prop: 'CREATOR' },
    { label: '创建时间', prop: 'CREATE_TIME' },
    { label: '修改人工号', prop: 'MODIFIER_NO' },
...
export const gfdc_auth_dictionary: TableOpt = {
  ...
  fields: [
    { label: 'ID', prop: 'ID' },
    { label: '字典编码', prop: 'DICT_CODE' },
    { label: '字典名', prop: 'DICT_NAME' },
    { label: '字典英文名', prop: 'DICT_NAME_EN' },
    { label: '描述', prop: 'DESCRIPTION' },
    { label: '排序', prop: 'ORDER_NUM' },
    { label: '1启用', prop: 'USE_STATE', options: [{ label: '禁用', value: 0 }, { label: '启用', value: 1 }] },
    { label: '创建人工号', prop: 'CREATOR_NO' },
    { label: '创建人', prop: 'CREATOR' },
    { label: '创建时间', prop: 'CREATE_TIME' },
    { label: '修改人工号', prop: 'MODIFIER_NO' },
...
export const gfdc_auth_dictionary_item: TableOpt = {
  ...
  fields: [
    { label: 'ID', prop: 'ID' },
    { label: '字典ID', prop: 'DICTIONARY', relation: { table: 'gfdc_auth_dictionary', rel: 'n-1' }, inverseSide: { label: '字典 Item', prop: 'ITEMS' } },
    { label: '字典名', prop: 'ITEM_NAME', filter: 'contains' },
    { label: '字典英文名', prop: 'ITEM_NAME_EN' },
    { label: '字典值', prop: 'ITEM_VALUE' },
    { label: '描述', prop: 'DESCRIPTION' },
    { label: '排序', prop: 'ORDER_NUM' },
    { label: '1启用', prop: 'ITEM_STATE', options: [{ label: '禁用', value: 0 }, { label: '启用', value: 1 }] },
    { label: '创建人工号', prop: 'CREATOR_NO' },
    { label: '创建人', prop: 'CREATOR' },
    { label: '创建时间', prop: 'CREATE_TIME' },
    { label: '修改人工号', prop: 'MODIFIER_NO' },
