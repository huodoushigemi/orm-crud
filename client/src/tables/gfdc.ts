...
export const gfdc_auth_user: TableOpt = {
  ...
  fields: [
    ...
    { label: '用户头像url', prop: 'PERSON_PHOTO', render: { is: 'my-img',  } },
  ...
  columns: ['EMP_NO', 'USER_NAME', 'USER_ACCOUNT', 'USER_STATE', 'PERSON_PHOTO', 'USER_ROLE.ROLE', 'MOBILE', 'EMAIL'],
...
export const gfdc_auth_resource: TableOpt = {
  ...
  fields: [
    ...
    { label: '浏览器页签', prop: 'OPEN_TYPE', options: [{ label: '菜单', value: 0 }, { label: 'iframe', value: 1 }] },
    { label: '外链地址', prop: 'EXT_URL' },
    { label: '认证信息', prop: 'EXT_PARAMS' },
    { label: '菜单等级', prop: 'RESOURCE_LEVEL' },
    { label: '排序', prop: 'SORT_TYPE' },
    { label: '父', prop: 'PARENT', relation: { table: 'gfdc_auth_resource', rel: 'n-1' }, inverseSide: { label: '菜单', prop: 'CHILDREN' } },
